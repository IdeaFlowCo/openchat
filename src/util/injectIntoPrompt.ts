...
export function injectIntoFollowupPrompt(feedbackTitle: string, feedbackDescription: string) {
    ...
    The title of the feedback is : ${feedbackTitle}

    The description of the feedback is: ${feedbackDescription}.
    ...
    Greet the human talking to you by telling them your name, and that the purpose of this conversation is to ask them followup questions about the feedback they just submitted and then ask your first question.

    After around 3 to 5 or so questions, you should have enough information to make a decision on whether or not you have achieved your goal. If you have, you can end the interview. If you have not, you can ask more questions.
    `;
}
