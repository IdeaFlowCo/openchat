...
function SingleSubmission({ submission }) {
    ...
    return (
        <div className="flex flex-col gap-4 border border-black/10 p-8 rounded-xl w-full">
            ...
            {toggleTranscript ? (
                <>
                    <button
                        ...
                        className=" inline-flex justify-center py-2 px-4 w-fit text-sm font-medium rounded-md bg-indigo-600 hover:bg-indigo-500 text-white border border-gray-300"
                    >
                        Back to Summary
                    </button>
