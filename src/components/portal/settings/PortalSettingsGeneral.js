...
import { updatePortal } from 'util/db';
import { useForm } from 'react-hook-form';
import Spinner from 'components/atoms/Spinner';
import { toast } from 'react-hot-toast';
import { useRouter } from 'next/router';

export default function PortalSettingsGeneral({ portalData }) {
  ...
  const onSubmit = (data) => {
    setLoading(true);
    console.log(data);
    updatePortal(portalData.id, data)
      .then(() => {
        toast.success('Portal settings updated');
      })
      .catch((error) => {
        // console.log(
        //     "Error updating portal settings",
        //     error.message
        // );
        if (
          ...
          toast.error('Portal name already exists');
          // Reload the page to show old data
          router.reload();
        }
      });
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className=''>
      <div className='space-y-12'>
        <div className=' pb-12'>
          ...
          <p className='mt-1 text-sm leading-6 text-gray-600'>
            This information is used to customize your portal.
          </p>
              ...
              <div className='mt-2'>
                <div className='flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md'>
                  ...
                  <input
                    ...
                    defaultValue={portalData.portal_name}
                    ref={register({
      ...
      <div className='fixed bottom-4 right-4 mt-6 flex items-center justify-end gap-x-6 sm:static'>
        <button
          type='button'
