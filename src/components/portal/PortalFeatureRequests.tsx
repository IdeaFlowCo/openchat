...
export default function PortalFeatureRequests({ portalData }) {
  ...
  const {
    ...
    refetch,
  } = useFeedbackByPortal(portalData?.id, statusesFilterList, topicsFilterList);
      ...
      >
        ...
        <li className='w-full '>
          ...
          >
            ...
            <div className='py-1'>
              <p className='px-10 py-3 text-[11px] text-gray-400'>Statuses</p>
              {portalData?.statuses.map((status) => (
                <button
                  ...
                  onClick={() => {
                    if (statusesFilterList.includes(status.name)) {
                ...
                >
                  ...
                  {statusesFilterList.includes(status.name) && (
            ...
            <div className='py-1'>
              <p className='px-10 py-3 text-[11px] text-gray-400'>Topics</p>
              {topics &&
                topics?.map((topic) => (
                  <button
                    className={classNames(
                    ...
                    onClick={() => {
                      if (topicsFilterList.includes(topic)) {
                        setTopicsFilterList(
                          topicsFilterList.filter((item) => item !== topic)
                        );
                      } else {
                        setTopicsFilterList([...topicsFilterList, topic]);
                      }
                    }}
                    key={topic}
                  >
        ...
        <li className=''>
          ...
          >
            Powered by{' '}
            <span className=' font-medium text-indigo-600'>Deepform</span>
          </a>
        </li>
        {/* </ul> */}
        {/* </nav> */}
          ...
          <div className='flex justify-between px-2 md:px-10'>
            <div className='flex flex-col gap-4'>
              <h1 className='font-satoshi text-3xl font-medium tracking-tight text-gray-900 md:text-4xl'>
                {portalData?.portal_name ? portalData.portal_name : ''} Feature
                Requests
              </h1>
