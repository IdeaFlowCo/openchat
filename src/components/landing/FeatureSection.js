            ...
            <div className='lg:pr-8 lg:pt-4'>
              <div className='lg:max-w-lg'>
                ...
                <p className='mt-6 text-lg leading-8 text-gray-600'>
                  Customer feedback is the lifeblood of your company. Collect
                  ideas in one place and let the most voted and commented ideas
                  surface to the top.
                </p>
          ...
          <div className='mx-auto grid max-w-2xl grid-cols-1 items-center justify-center gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2'>
            <div className='lg:ml-auto lg:pl-4 lg:pt-4'>
              <div className='lg:max-w-lg'>
                ...
                <p className='mt-6 text-lg leading-8 text-gray-600'>
                  Turn raw feedback into insights in minutes, not days with an
                  intuitive admin experience, in-depth A.I. analysis, and more.
                </p>
                <dl className='mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none'>
