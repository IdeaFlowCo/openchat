                ...
                <div className="mx-auto grid max-w-2xl grid-cols-1 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    <div className="flex flex-col pb-10 sm:pb-16 lg:pb-0 lg:pr-8 xl:pr-20">
                        ...
                        <figure className="mt-10 flex flex-auto flex-col justify-between">
                            <blockquote className="text-lg leading-8 text-gray-900">
                                <p>
                                    “Research at its core is learning. The more
                                    research you do and the faster you learn,
                                    the faster your decision-making will be.”
                                </p>
                            </blockquote>
                            <figcaption className="mt-10 flex items-center gap-x-6">
                                ...
                                <div className="text-base">
                                    <a
                                        className="font-semibold text-gray-900 border-b border-gray-900"
                    ...
                    <div className="flex flex-col border-t border-gray-900/10 pt-10 sm:pt-16 lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0 xl:pl-20">
                        ...
                        <figure className="mt-10 flex flex-auto flex-col justify-between">
                            <blockquote className="text-lg leading-8 text-gray-900">
                                <p>
                                    “Once you have more insights on a certain
                                    topic and more information about the pros
                                    and cons of the options you're facing,
                                    there's a higher chance that the whole team
                                    knows more and has higher confidence in
                                    decision-making.”
                                </p>
                            </blockquote>
                            <figcaption className="mt-10 flex items-center gap-x-6">
